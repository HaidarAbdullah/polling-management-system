...
public class SupervisedRoomsViewHolder extends RecyclerView.ViewHolder {
    TextView tv1,tv2,tv3,tv4;


    public SupervisedRoomsViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(SupervisedRoom room)
    {
