...
public class SupervisedRoom {
    ...
    public SupervisedRoom(int id, String room_identifier, int creator_id, String open_time, String close_time, boolean is_conditional, int condition_type, String condition_desc, String title) {
        this.id = id;
